...
import Idiot_Dinosaur_GA_trex_nn
...
GAMEOVER_BOX = {'Y_GAMEOVER': 30, 'X_GAMEOVER': 115, 'W_GAMEOVER': 200, 'H_GAMEOVER': 15}
GAMEOVER_RANGE = [630000,689669]
TIME_BETWEEN_FRAMES = 0.01
TIME_BETWEEN_GAME = 0.5
...
def play_game(parameters_set):
    ...
    with mss() as sct:
        ...
        while True:
            ...
            Idiot_Dinosaur_GA_trex_nn.wrap_model(input_set, parameters_set, N_X)
            print("Distance: " + str(distance) + " Last_Distance: " + str(last_distance))
            if distance == x2:
                continue
                ...
                if len(distance_array):
                    ...
                    if start_time:
                        ...
                        speed = compute_speed(distance_array, distance, speed, loop_time, max_speed_step = MAX_SPEED_STEP)
            ...
            #print("IS GAME OVER? " + str(gameover_state))
            print("Number Cactus Pass: " + str(count_cactus))
            if gameover_state:
