...
import Idiot_Dinosaur_capturing_objects
import time
import logging
...
def genesis(pop_size = POP_SIZE):
    trex_clan = [Idiot_Dinosaur_GA_trex_nn.initialize_parameters(N_X, N_H, N_Y) for i in range(POP_SIZE)]
...
Idiot_Dinosaur_capturing_objects.chrome_setup(URL)
time.sleep(3)
evolve()